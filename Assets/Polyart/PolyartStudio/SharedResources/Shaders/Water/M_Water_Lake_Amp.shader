...
Shader "M_Water_Lake_Amp"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float _Waves02Scale;
			float _Waves02Speed;
			float _WaterEdgeDistance;
			float _CausticsOpacity;
			float _WaterMaxOpacity;
			float _WaterShallowOpacityDistance;
			float _CausticsDistance;
			float _CausticsIntensity;
			float _CausticsDistortion;
			float _CausticsSpeed;
			float _CausticsHeightOffset;
			float _CausticsScale;
			float _FoamOpacity1;
			float _FoamDistance1;
			float _FoamTiling;
			float _ShallowWaterDistance;
			float _Waves01Speed;
			float _Waves01Scale;
						 ...
						 ) : SV_Target
			{
				...
				float4 appendResult36 = (float4(WorldPosition.x , WorldPosition.z , 0.0 , 0.0));
				float3 tex2DNode9 = UnpackNormalScale( tex2D( _WavesNormal, ( ( appendResult36 / _Waves01Scale ) + float4( ( ( _Waves01Speed * _TimeParameters.x ) * float2( 0.8,1 ) ), 0.0 , 0.0 ) ).xy ), 1.0f );
				float3 Refraction_Normal151 = tex2DNode9;
				float4 fetchOpaqueVal190 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( ( ase_positionSSNorm + float4( ( _Refraction1 * Refraction_Normal151 ) , 0.0 ) ).xy.xy ), 1.0 );
				float depthLinearEye43 = LinearEyeDepth( SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ), _ZBufferParams );
				float4 lerpResult6 = lerp( _ColorShallow , _ColorDeep , saturate( ( ( depthLinearEye43 - ScreenPos.w ) * _ShallowWaterDistance ) ));
				float4 vDepthColor7 = lerpResult6;
				float4 temp_cast_4 = (1.0).xxxx;
				float mulTime213 = _TimeParameters.x * _Waves02Speed;
				float time200 = ( mulTime213 * 50 );
				float2 voronoiSmoothId200 = 0;
				float2 appendResult217 = (float2(WorldPosition.x , WorldPosition.z));
				...
				float distanceDepth211 = abs( ( screenDepth211 - LinearEyeDepth( ase_positionSSNorm.z,_ZBufferParams ) ) / ( ( _FoamDistance1 * 0.3 ) ) );
				float Foam210 = ( saturate( ( pow( saferPower203 , -1.5 ) + ( 1.0 - distanceDepth211 ) ) ) * _FoamOpacity1 );
				float4 lerpResult128 = lerp( vDepthColor7 , temp_cast_4 , Foam210);
				float4 appendResult147 = (float4(WorldPosition.x , WorldPosition.z , 0.0 , 0.0));
				float3 ase_viewDirSafeTS = SafeNormalize( WorldViewDirection );
				float2 paralaxOffset144 = ParallaxOffset( 0 , _CausticsHeightOffset , ase_viewDirSafeTS );
				float mulTime155 = _TimeParameters.x * _CausticsSpeed;
				float depthLinearEye172 = LinearEyeDepth( SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ), _ZBufferParams );
				float4 lerpResult177 = lerp( saturate( ( tex2D( _CausticsTexture, ( ( ( ( appendResult147 / _CausticsScale ) + float4( paralaxOffset144, 0.0 , 0.0 ) ) + float4( ( mulTime155 * float2( 1,0 ) ), 0.0 , 0.0 ) ) + ( Refraction_Normal151.x * _CausticsDistortion ) ).xy ) * _CausticsIntensity ) ) , float4( 0,0,0,0 ) , saturate( ( ( depthLinearEye172 - ScreenPos.w ) * _CausticsDistance ) ));
				float4 Caustics166 = lerpResult177;
				float depthLinearEye59 = LinearEyeDepth( SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ), _ZBufferParams );
				float depthLinearEye54 = LinearEyeDepth( SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_positionSSNorm.xy ), _ZBufferParams );
				float temp_output_58_0 = saturate( ( ( depthLinearEye54 - ScreenPos.w ) * _WaterEdgeDistance ) );
				float Opacity130 = ( ( ( min( saturate( ( ( depthLinearEye59 - ScreenPos.w ) * _WaterShallowOpacityDistance ) ) , _WaterMaxOpacity ) + Foam210 ) + ( length( Caustics166 ) * _CausticsOpacity ) ) * temp_output_58_0 );
				float4 lerpResult183 = lerp( fetchOpaqueVal190 , ( lerpResult128 + Caustics166 ) , Opacity130);
				float4 FinalColor229 = lerpResult183;
				
				float4 appendResult37 = (float4(WorldPosition.x , WorldPosition.z , 0.0 , 0.0));
				float3 lerpResult39 = lerp( float3(0,0,1) , BlendNormal( tex2DNode9 , UnpackNormalScale( tex2D( _WavesNormal, ( ( _TimeParameters.x * _Waves02Speed ) + ( appendResult37 / _Waves02Scale ) ).xy ), 1.0f ) ) , _NormalStrength);
				float3 Normal222 = lerpResult39;
				
				float OpacityOutput226 = temp_output_58_0;
				

				float3 BaseColor = FinalColor229.rgb;
		...
		Pass
		{
			...
			half4 frag(PackedVaryings input ) : SV_Target
			{
				...
				surfaceDescription.Alpha = OpacityOutput226;
...
Node;AmplifyShaderEditor.ScreenDepthNode;54;-3930.488,-832.2648;Inherit;False;0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;57;-3456.915,-723.8301;Inherit;False;Property;_WaterEdgeDistance;Water Edge Distance;21;0;Create;True;0;0;0;False;1;HEADER(Opacity);False;0;-13.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;9;-2876.828,226.3194;Inherit;True;Property;_T_WaterNormal_01;T_WaterNormal_01;3;0;Create;True;0;0;0;False;0;False;-1;4ea058df3811fdf439d5bff6fbdb2316;4ea058df3811fdf439d5bff6fbdb2316;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;148;-4361.938,1419.415;Inherit;False;Property;_CausticsScale;Caustics Scale;13;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;50;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;150;-4359.726,1499.782;Inherit;False;Property;_CausticsHeightOffset;Caustics Height Offset;18;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;156;-4051.381,1648.1;Inherit;False;Property;_CausticsSpeed;Caustics Speed;15;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;0.025;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;224;-3316.364,987.0937;Inherit;False;Property;_Waves02Speed;Waves 02 Speed;24;0;Fetch;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;162;-3544.494,1672.521;Inherit;False;Property;_CausticsDistortion;Caustics Distortion;16;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;0.1;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;198;-3200.263,1163.692;Inherit;False;Property;_FoamDistance1;Foam Distance;10;0;Create;False;0;0;0;False;1;HEADER(Foam);False;0.07;0.207;0.01;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;197;-2938.081,1064.207;Inherit;False;Property;_FoamTiling;Foam Tiling;8;1;[Header];Create;False;1;Foam;0;0;False;1;HEADER(Foam);False;50;4;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenDepthNode;172;-2979.28,1633.381;Inherit;False;0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;165;-2597.597,1498.683;Inherit;False;Property;_CausticsIntensity;Caustics Intensity;14;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;0.1;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;175;-2505.704,1741.817;Inherit;False;Property;_CausticsDistance;Caustics Distance;11;1;[Header];Create;True;1;Caustics;0;0;False;1;HEADER(Caustics);False;0.1;-13.06;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;163;-2897.438,1427.161;Inherit;True;Property;_CausticsTexture;Caustics Texture;12;0;Create;True;0;0;0;False;0;False;-1;e805e35c15a0161448afe9d296eecfa2;e805e35c15a0161448afe9d296eecfa2;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ScreenDepthNode;59;-4258.832,-1186.782;Inherit;False;0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;62;-4055.212,-972.2425;Inherit;False;Property;_WaterShallowOpacityDistance;Water Shallow Opacity Distance;20;0;Create;True;0;0;0;False;1;HEADER(Opacity);False;0;-13.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;207;-2178.871,1130.75;Inherit;False;Property;_FoamOpacity1;FoamOpacity;9;0;Create;False;0;0;0;False;1;HEADER(Foam);False;0;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenDepthNode;43;-3204.082,-219.6112;Inherit;False;0;1;0;FLOAT4;0,0,0,0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;67;-3737.866,-970.3265;Inherit;False;Property;_WaterMaxOpacity;Water Max Opacity;19;1;[Header];Create;True;1;Opacity;0;0;False;1;HEADER(Opacity);False;0.91;-13.06;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;180;-3453.87,-807.0458;Inherit;False;Property;_CausticsOpacity;Caustics Opacity;17;0;Create;True;0;0;0;False;1;HEADER(Caustics);False;0.2;-13.06;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;27;-3504.31,636.9872;Inherit;False;Property;_Waves02Scale;Waves 02 Scale;7;0;Create;True;0;0;0;False;1;HEADER(Normals);False;12;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;5;-2575.781,-462.4581;Inherit;False;Property;_ColorShallow;Color Shallow;0;0;Create;True;0;0;0;False;1;Header(Color);False;0.5990566,0.9091429,1,0;0,0.6274511,0.7176471,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.ColorNode;3;-2572.283,-295.8587;Inherit;False;Property;_ColorDeep;Color Deep;1;0;Create;True;0;0;0;False;0;False;0.1213065,0.347919,0.5471698,0;0,0.3372549,0.3882353,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;187;-2380.941,-749.0635;Inherit;False;Property;_Refraction1;Refraction;23;0;Create;True;0;0;0;False;1;HEADER(Basic Attributes);False;0.85;1;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;25;-2878.034,425.3209;Inherit;True;Property;_TextureSample1;Texture Sample 1;7;0;Create;True;0;0;0;False;0;False;-1;4ea058df3811fdf439d5bff6fbdb2316;4ea058df3811fdf439d5bff6fbdb2316;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;35;-1271.829,327.9157;Inherit;False;Property;_Smoothness;Smoothness;22;1;[Header];Create;True;1;Basic Attributes;0;0;False;1;HEADER(Basic Attributes);False;1;1;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;131;-1440,-464;Inherit;False;130;Opacity;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;232;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;234;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;235;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;236;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;237;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;238;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;239;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;240;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;241;-752,208;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;233;-704,224;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;M_Water_Lake_Amp;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;21;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;43;Lighting Model;0;0;Workflow;1;0;Surface;1;638683981186803417;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Alpha Clipping;0;638683981701684965;  Use Shadow Threshold;0;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;Receive Shadows;1;0;Receive SSAO;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
...
WireConnection;233;4;35;0
WireConnection;233;6;227;0
ASEEND*/
//CHKSM=F49BF8E28232DDCE18E865EDE120EEECDE10B49D