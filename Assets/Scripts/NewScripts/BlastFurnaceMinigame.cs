...
public class BlastFurnaceMinigame : MonoBehaviour, IMinigame
{
    ...
    public float GetCurrentRequiredValue()
    {
        return currentRequiredValue;
    }

    public float GetCurrentPerfectValue()
    {
        return currentPerfectValue;
    }

    public float GetCurrentCriticalFailureValue()
    {
        return currentCriticalFailureValue;
    }

    public float CalculateValueDifference()
    {
        return Mathf.Abs(currentRequiredValue - playerValue);
    }

    public float CalculatePerfectValueDifference()
    {
